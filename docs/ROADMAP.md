...
5. Phase 1C-Design: Order Domain Architecture Review package - complete; implementation requires a separate Architecture Owner approval.
6. Phase 2: Customer preorder only after Architecture Owner approval.
7. Phase 3: POS and Kitchen pilot from the same REST/SSE source.
8. Phase 4: Cost ledger and daily Sales Contract import, then Google Sheets reporting export.
