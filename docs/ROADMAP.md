...
7. Phase 1C-2: Order Lifecycle - complete under DECISIONS #007; manual status, no-show, one-time release, Event Close, daily report, audit, and lifecycle UI.
8. Phase 2: Customer preorder only after Architecture Owner approval.
9. Phase 3: POS and Kitchen pilot from the same REST/SSE source.
10. Phase 4: Cost ledger and daily Sales Contract import, then Google Sheets reporting export.
