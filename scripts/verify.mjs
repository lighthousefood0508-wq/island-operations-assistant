...
const commands = [
  ...
  ["tests", ["--test", "dist/tests/health.test.js", "dist/tests/contracts.test.js", "dist/tests/architecture-guards.test.js", "dist/tests/catalog.test.js", "dist/tests/catalog-api.integration.test.js"]],
