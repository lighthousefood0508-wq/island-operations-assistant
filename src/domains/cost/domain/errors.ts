...
export class InvalidAcceptedPurchaseIdentity extends CostDomainError { readonly code = "INVALID_ACCEPTED_PURCHASE_IDENTITY"; constructor() { super("Accepted Purchase identity must use accepted_purchase_<uuid> format."); } }
export class InvalidAcceptedPurchaseLineIdentity extends CostDomainError { readonly code = "INVALID_ACCEPTED_PURCHASE_LINE_IDENTITY"; constructor() { super("Accepted Purchase line identity must use accepted_purchase_line_<uuid> format."); } }
export class InvalidCostSnapshotIdentity extends CostDomainError { readonly code = "INVALID_COST_SNAPSHOT_IDENTITY"; constructor() { super("Cost Snapshot identity must use cost_snapshot_<uuid> format."); } }
export class InvalidCostSnapshot extends CostDomainError { readonly code = "INVALID_COST_SNAPSHOT"; constructor(message: string) { super(message); } }
export class InvalidAcceptedPurchase extends CostDomainError { readonly code = "INVALID_ACCEPTED_PURCHASE"; constructor(message: string) { super(message); } }
export class AcceptedPurchaseAlreadyExists extends CostDomainError { readonly code = "ACCEPTED_PURCHASE_ALREADY_EXISTS"; constructor(purchaseId: string) { super(`Purchase ${purchaseId} already has Accepted Purchase evidence.`); } }
