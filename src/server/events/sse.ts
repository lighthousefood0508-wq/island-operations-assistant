...
export type RosEventType = "order.created" | "order.updated" | "order.production_changed" | "order.completed" | "payment.confirmed" | "inventory.changed" | "event.opened" | "event.paused" | "event.resumed" | "event.closed" | "closeout.updated";
