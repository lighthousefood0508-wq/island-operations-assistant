...
ROS v0.4 is released locally at `v0.4-order-core`; see `docs/releases/RELEASE_v0.4.md`. Phase 1C.1 POS Minimal UI is approved under **DECISIONS #006** and has not yet begun.
