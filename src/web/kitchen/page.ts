...
<body>
  ...
  <script>
    ...
    const state={event:null,orders:[],products:[],activeTab:'pending',baselineEventId:null,renderFingerprint:null,voiceSettings:readVoiceSettings(),reminderLedger:readReminderLedger()};
    ...
    sync.registerLoad(load);renderVoiceSettings();setInterval(()=>{updateTimingLabels();processAutomaticVoice(false)},30000);
  </script>
</body>
</html>`;
}
