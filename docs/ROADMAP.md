...
6. Phase 1C.1: POS Minimal UI - approved under DECISIONS #006; shopping cart and Order API submission only.
7. Phase 2: Customer preorder only after Architecture Owner approval.
8. Phase 3: POS and Kitchen pilot from the same REST/SSE source.
9. Phase 4: Cost ledger and daily Sales Contract import, then Google Sheets reporting export.
