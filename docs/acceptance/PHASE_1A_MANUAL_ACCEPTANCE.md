...
| --- | --- | --- | --- | --- | --- |
| Create category | Unique lowercase code and active category appear in list | [ ] | [ ] | | |
...
Create category `bento` / `便當` / sort `10`. Create product `一曲東坡肉`, POS short name `東坡`, price `180`, and enable `pos`. Save the draft, then select **發布新版本**.
