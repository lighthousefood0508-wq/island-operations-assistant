...
12. Phase 2: Customer preorder only after Architecture Owner approval.
13. Phase 3: POS and Kitchen pilot from the same REST/SSE source.
14. Phase 4: Cost ledger and daily Sales Contract import, then Google Sheets reporting export.
